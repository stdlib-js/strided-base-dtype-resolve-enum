...
```javascript
resolve = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dtype-resolve-enum@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dtype-resolve-enum@umd/bundle.js"></script>
```
